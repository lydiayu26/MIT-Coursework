...
if False:
    mean, std = plotMeans(1, 1000000, 19, 'Mean of 1 die', 'g', '*')
    print('Mean of rolling 1 die =', str(mean) + ',', 'Std =', std)
    mean, std = plotMeans(5, 1000000, 19, 'Mean of 5 dice', 'b', '-')
    print('Mean of rolling 5 die =', str(mean) + ',', 'Std =', std)
    mean, std = plotMeans(25, 1000000, 19, 'Mean of 25 dice', 'r', '//')
    print('Mean of rolling 25 dice =', str(mean) + ',', 'Std =', std)
    mean, std = plotMeans(125, 1000000, 19, 'Mean of 125 dice', 'g', '/')
    print('Mean of rolling 125 dice =', str(mean) + ',', 'Std =', std)
    pylab.title('Rolling Continuous Dice')
    pylab.xlabel('Value')
    pylab.ylabel('Probability')
    pylab.legend()

## code for slides 40-41
class FairRoulette():
    def __init__(self):
        self.pockets = []
        for i in range(1,37):
