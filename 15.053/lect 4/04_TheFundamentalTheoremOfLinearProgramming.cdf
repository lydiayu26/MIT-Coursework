...
NotebookDataLength[     83551,       1670]
NotebookOptionsPosition[     56603,       1093]
NotebookOutlinePosition[     82876,       1654]
CellTagsIndexPosition[     82765,       1648]
WindowTitle->The Fundamental Theorem of Linear Programming
WindowFrame->Normal*)
...
Cell["The Fundamental Theorem of Linear Programming", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = 9, $CellContext`b$$ = 
    3, $CellContext`c$$ = 5, $CellContext`n$$ = 5, $CellContext`sr$$ = 123, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 5, "number of corners"}, 3, 12, 1}, {{
       Hold[$CellContext`a$$], 9, "coefficient a"}, -20, 20}, {{
       Hold[$CellContext`b$$], 3, "coefficient b"}, -20, 20}, {{
       Hold[$CellContext`c$$], 5, "value of obj. func."}, -128.7075766275508, 
      147.69674461908292`}, {{
       Hold[$CellContext`sr$$], 123, "random seed"}, 1, 12345, 1}}, 
    Typeset`size$$ = {350., {249.5, 254.5}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`n$38536$$ = 0, $CellContext`a$38537$$ = 
    0, $CellContext`b$38538$$ = 0, $CellContext`c$38539$$ = 
    0, $CellContext`sr$38540$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = 9, $CellContext`b$$ = 
        3, $CellContext`c$$ = 5, $CellContext`n$$ = 5, $CellContext`sr$$ = 
        123}, "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$38536$$, 0], 
        Hold[$CellContext`a$$, $CellContext`a$38537$$, 0], 
        Hold[$CellContext`b$$, $CellContext`b$38538$$, 0], 
        Hold[$CellContext`c$$, $CellContext`c$38539$$, 0], 
        Hold[$CellContext`sr$$, $CellContext`sr$38540$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       SeedRandom[$CellContext`sr$$]; $CellContext`corners = 
        Table[{10 Cos[2 Pi $CellContext`k], 10 
           Sin[2 Pi $CellContext`k]}, {$CellContext`k, 
           Sort[
            Table[
             Random[], {$CellContext`n$$}]]}]; $CellContext`max = Max[
          
          Map[$CellContext`a$$ First[#] + $CellContext`b$$ 
            Last[#]& , $CellContext`corners]]; $CellContext`min = Min[
          
          Map[$CellContext`a$$ First[#] + $CellContext`b$$ 
            Last[#]& , $CellContext`corners]]; Column[{
          Text[
           Grid[{{
              Row[{"Maximum value: ", $CellContext`max}]}, {
              Row[{"Minimum value: ", $CellContext`min}]}, {
              If[
               Or[$CellContext`a$$ != 0, $CellContext`b$$ != 0], 
               Style[
                
                Row[{$CellContext`a$$, "x + ", $CellContext`b$$, "y", 
                  " = ", $CellContext`c$$}], 12, Red], 
               "No objective function"]}}]], 
          Show[
           If[$CellContext`b$$ != 0, 
            
            Plot[((-$CellContext`a$$)/$CellContext`b$$) $CellContext`x + \
$CellContext`c$$/$CellContext`b$$, {$CellContext`x, -10, 10}, 
             AxesOrigin -> {0, 0}, AspectRatio -> 1], 
            If[$CellContext`a$$ != 0, 
             Graphics[{Blue, 
               
               Line[{{$CellContext`c$$/$CellContext`a$$, -14}, \
{$CellContext`c$$/$CellContext`a$$, 12}}]}, 
              PlotRange -> {{-11, 11}, {-10, 14}}, Axes -> True], 
             Graphics[
              Text["", {0, 0}]]]], 
           Graphics[{{
              Map[{
                PointSize[0.02], 
                Point[#]}& , $CellContext`corners]}, {LightGray, 
              Opacity[0.5], 
              EdgeForm[Black], 
              Polygon[$CellContext`corners]}, 
             If[
              And[
               Or[$CellContext`a$$ != 0, $CellContext`b$$ != 0], Length[
                 $CellContext`intpts[$CellContext`corners, $CellContext`a$$, \
$CellContext`b$$, $CellContext`c$$]] > 0], {Red, Thick, 
               Line[Part[
                   $CellContext`intpts[$CellContext`corners, \
$CellContext`a$$, $CellContext`b$$, $CellContext`c$$], All, 3] Part[
                   $CellContext`intpts[$CellContext`corners, \
$CellContext`a$$, $CellContext`b$$, $CellContext`c$$], All, 1] + (1 - Part[
                   $CellContext`intpts[$CellContext`corners, \
$CellContext`a$$, $CellContext`b$$, $CellContext`c$$], All, 3]) Part[
                   $CellContext`intpts[$CellContext`corners, \
$CellContext`a$$, $CellContext`b$$, $CellContext`c$$], All, 2]]}, 
              Text["", {0, 0}]]}], PlotRange -> {{-11, 11}, {-10, 14}}, 
           ImageSize -> {350, 450}]}, Center]), 
      "Specifications" :> {{{$CellContext`n$$, 5, "number of corners"}, 3, 12,
          1, ImageSize -> 
         Small}, {{$CellContext`a$$, 9, "coefficient a"}, -20, 20, ImageSize -> 
         Small}, {{$CellContext`b$$, 3, "coefficient b"}, -20, 20, ImageSize -> 
         Small}, {{$CellContext`c$$, 5, 
          "value of obj. func."}, -128.7075766275508, 147.69674461908292`, 
         ImageSize -> Small}, {{$CellContext`sr$$, 123, "random seed"}, 1, 
         12345, 1, ImageSize -> Small}}, 
      "Options" :> {
       ControlPlacement -> Left, 
        TrackedSymbols :> {$CellContext`n$$, $CellContext`a$$, \
$CellContext`b$$, $CellContext`c$$, $CellContext`sr$$}, 
        AutorunSequencing -> {1, 2, 3, 5}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{600., {279., 284.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`corners = {{8.795743568333975, 
         4.757614431636038}, {-1.5552689921374663`, 
         9.878316575312603}, {-5.602165717852644, -8.283461792615245}, {
         2.661867992626573, -9.639214635530749}, {
         5.346693483523826, -8.450613515789481}}, $CellContext`max = 
        137.69674461908292`, $CellContext`min = -118.70757662755078`, 
        Attributes[PlotRange] = {ReadProtected}, $CellContext`intpts[
          ...
          MapThread[$CellContext`intersect[#, #2, $CellContext`a, \
$CellContext`b, $CellContext`c]& , {$CellContext`list, 
            RotateLeft[$CellContext`list]}], And[
          Last[#] >= 0, Last[#] < 1]& ], $CellContext`intersect[
          ...
          Pattern[$CellContext`b, 
           Blank[]], 
          Pattern[$CellContext`c, 
           Blank[]]] := {$CellContext`pt1, $CellContext`pt2, 
          
          If[$CellContext`b == 
           0, -((-$CellContext`c + $CellContext`a 
              First[$CellContext`pt2])/($CellContext`a (
             First[$CellContext`pt1] - First[$CellContext`pt2]))), 
           
           If[$CellContext`slope[$CellContext`pt1, $CellContext`pt2] == \
-($CellContext`a/$CellContext`b), 
            "Lines are parallel", (-$CellContext`c + $CellContext`a 
              First[$CellContext`pt2] + $CellContext`b 
              Last[$CellContext`pt2])/((-$CellContext`a) 
             First[$CellContext`pt1] + $CellContext`a 
             First[$CellContext`pt2] - $CellContext`b 
            Last[$CellContext`pt1] + $CellContext`b 
             Last[$CellContext`pt2])]]}, $CellContext`slope[
          Pattern[$CellContext`pt1, 
           Blank[]], 
          Pattern[$CellContext`pt2, 
           Blank[]]] := 
        If[First[$CellContext`pt1] != 
          First[$CellContext`pt2], (Last[$CellContext`pt2] - 
           Last[$CellContext`pt1])/(First[$CellContext`pt2] - 
          First[$CellContext`pt1]), Null]}; Typeset`initDone$$ = True); 
     ReleaseHold[{{
         HoldComplete[$CellContext`slope[
             Pattern[$CellContext`pt1, 
              Blank[]], 
             Pattern[$CellContext`pt2, 
              Blank[]]] := 
           If[First[$CellContext`pt1] != 
             First[$CellContext`pt2], (Last[$CellContext`pt2] - 
              Last[$CellContext`pt1])/(First[$CellContext`pt2] - 
             First[$CellContext`pt1]), Null]; Null], 
         HoldComplete[Null], 
         HoldComplete[Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`intersect[
             Pattern[$CellContext`pt1, 
              Blank[]], 
             Pattern[$CellContext`pt2, 
              Blank[]], 
...
(-$CellContext`a)/$CellContext`b, 
               "Lines are parallel", (-$CellContext`c + $CellContext`a 
                ...
                First[$CellContext`pt2] - $CellContext`b 
               Last[$CellContext`pt1] + $CellContext`b 
                Last[$CellContext`pt2])]]}; Null], 
         HoldComplete[Null], 
         HoldComplete[Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`intpts[
             Pattern[$CellContext`list, 
              Blank[]], 
             Pattern[$CellContext`a, 
              Blank[]], 
...
Cell[TextData[{
 "A weak version of what is sometimes called the fundamental theorem of \
linear programming states that the extremal values of a linear function ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"f", 
    ...
    RowBox[{
     RowBox[{"a", " ", "x"}], "+", 
     RowBox[{"b", " ", "y"}]}]}], TraditionalForm]], "InlineMath"],
 " over a convex polygonal region are attained at corners of the region. \
(Moreover, if an extremum is attained at two corners then it is attained \
everywhere on the line segment connecting them.) The function ",
 Cell[BoxData[
  FormBox["f", TraditionalForm]], "InlineMath"],
 " is called the objective function, and often represents profit or some \
other quantity to be optimized. The region is called the feasible set and \
represents all options for the variables ",
 Cell[BoxData[
  FormBox["x", TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox["y", TraditionalForm]], "InlineMath"],
 " that satisfy the constraints in the problem. Points on the red line in the \
Demonstration are those points in the feasible set that produce the given \
...
TheFundamentalTheoremOfLinearProgramming&version=0013"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
TheFundamentalTheoremOfLinearProgramming/\
TheFundamentalTheoremOfLinearProgramming-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["The Fundamental Theorem of Linear Programming",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
TheFundamentalTheoremOfLinearProgramming/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
TheFundamentalTheoremOfLinearProgramming/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Chris Boucher",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Chris+Boucher"],
     None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Chris+Boucher"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[46794, 853, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[47055, 862, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55781, 1068, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82478, 1637},
 {"Copyright", 82673, 1642}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[609, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34940, 590, 66, 0, 70, "DemoTitle"],
Cell[35009, 592, 10549, 229, 70, "Output",
 CellID->182561357],
Cell[45561, 823, 1230, 28, 70, "ManipulateCaption"],
Cell[46794, 853, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47055, 862, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48983, 908, 44, 0, 70, "RelatedLinksSection"],
Cell[49030, 910, 575, 20, 70, "RelatedLinks",
 CellID->228214463],
Cell[49608, 932, 4863, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[54474, 1025, 45, 0, 70, "CitationSection"],
Cell[54522, 1027, 926, 27, 70, "Citations"],
Cell[55451, 1056, 327, 10, 70, "Author"],
Cell[55781, 1068, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature uRUoYPkFL0R5ExAKaI0b5RaA *)
