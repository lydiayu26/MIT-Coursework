...
NotebookDataLength[     91848,       1821]
NotebookOptionsPosition[     64697,       1238]
NotebookOutlinePosition[     90971,       1799]
CellTagsIndexPosition[     90860,       1793]
WindowTitle->Graphical Linear Programming for Two Variables
WindowFrame->Normal*)
...
Cell["Graphical Linear Programming for Two Variables", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`corner$$ = 5, $CellContext`equations$$ = 
    False, $CellContext`objfunvalue$$ = 2, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`corner$$], 5, "solution at corner"}, {
      1 -> "B", 2 -> "C", 3 -> "D", 4 -> "E", 5 -> "F", 6 -> "B & C", 7 -> 
       "C & D", 8 -> "D & E", 9 -> "E & F", 10 -> "F & A"}}, {{
       Hold[$CellContext`objfunvalue$$], 2, "objective  function value"}, 1, 
      14, 0.25}, {{
       Hold[$CellContext`equations$$], False, "equations"}, {True, False}}}, 
    Typeset`size$$ = {360., {184., 188.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`corner$160778$$ = 
    False, $CellContext`objfunvalue$160779$$ = 
    0, $CellContext`equations$160780$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`corner$$ = 5, $CellContext`equations$$ = 
        False, $CellContext`objfunvalue$$ = 2}, "ControllerVariables" :> {
        Hold[$CellContext`corner$$, $CellContext`corner$160778$$, False], 
        Hold[$CellContext`objfunvalue$$, $CellContext`objfunvalue$160779$$, 
         0], 
        Hold[$CellContext`equations$$, $CellContext`equations$160780$$, 
         False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Show[$CellContext`labeledregion, 
        Plot[
         ReplaceAll[
          
          Part[$CellContext`objfun, $CellContext`corner$$], $CellContext`t -> \
$CellContext`objfunvalue$$], {$CellContext`x, -2, 8}, PlotRange -> {-2, 8.5}, 
         PlotStyle -> Directive[Black, Thick]], 
        If[$CellContext`equations$$, 
         Graphics[
          Inset[
           Grid[{{
              Panel[
               Grid[{{
                  Style[$CellContext`x + 2 $CellContext`y <= 6, ", ", 12, 
                   RGBColor[0.49, 0, 0]], 
                  Style[2 $CellContext`x + $CellContext`y <= 8, 12, 
                   RGBColor[0.6, 0.73, 0.36]]}, {
                  Style[-$CellContext`x + $CellContext`y <= 1, ", ", 12, 
                   RGBColor[0.25, 0.43, 0.82]], 
                  Style[$CellContext`y <= 2, 12, 
                   RGBColor[0.48, 0.11, 0.56]]}}], 
               Style["Constraints", 12, Bold, Background -> White]]}, {
              Panel[
               Grid[{{
                  Style[
                   Part[$CellContext`standardobjfun, $CellContext`corner$$], 
                   12], 
                  Style[" = ", 12], 
                  Style[
                   SetPrecision[$CellContext`objfunvalue$$, 4], 12]}}], 
               Style[
               "Objective Function Value", 12, Bold, Background -> 
                White]]}}], {3, 7}]], {}], Axes -> True, 
        AxesLabel -> {$CellContext`x, $CellContext`y}], 
      "Specifications" :> {{{$CellContext`corner$$, 5, 
          "solution at corner"}, {
         1 -> "B", 2 -> "C", 3 -> "D", 4 -> "E", 5 -> "F", 6 -> "B & C", 7 -> 
          "C & D", 8 -> "D & E", 9 -> "E & F", 10 -> "F & A"}, ControlType -> 
         SetterBar}, {{$CellContext`objfunvalue$$, 2, 
          "objective  function value"}, 1, 14, 0.25, Appearance -> 
         "Labeled"}, {{$CellContext`equations$$, False, "equations"}, {
         True, False}}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{405., {249., 254.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`labeledregion = Graphics[{
           GraphicsComplex[CompressedData["
1:
Q8264D9GIUNU
            "], {{{
               EdgeForm[], 
               RGBColor[
...
1:
                  "]], 
                 
                 Polygon[{{113, 168, 87, 42}, {141, 134, 56, 59}, {120, 150, 
                  63, 65}, {110, 115, 44, 57}, {144, 148, 61, 47}, {122, 153, 
                  67, 69}, {128, 170, 90, 41}, {124, 156, 71, 73}, {101, 167, 
                  84, 35}, {160, 126, 48, 56}, {131, 164, 79, 45}, {105, 158, 
                  73, 39}, {153, 121, 68, 67}, {127, 135, 57, 28}, {99, 165, 
                  81, 36}, {108, 100, 52, 55}, {96, 162, 77, 29}, {107, 97, 
                  50, 54}, {104, 155, 69, 38}, {125, 106, 53, 48}, {114, 107, 
                  54, 44}, {103, 152, 65, 37}, {130, 116, 58, 50}, {161, 108, 
                  55, 74}, {137, 101, 35, 58}, {106, 95, 49, 53}, {140, 139, 
                  39, 52}, {147, 161, 74, 61}, {150, 119, 64, 63}, {151, 102, 
                  36, 64}, {154, 103, 37, 68}, {95, 145, 60, 49}, {156, 123, 
                  72, 71}, {146, 142, 41, 60}, {157, 104, 38, 72}, {164, 98, 
                  29, 79}, {162, 129, 42, 77}, {165, 132, 45, 81}, {167, 118, 
                  47, 84}, {168, 112, 20, 87}, {170, 127, 28, 
                  90}}]}]}, {}, {}, {}}, {{
               Directive[{
                 Opacity[0.4], 
                 GrayLevel[0]}], 
               
               Line[{2, 1, 11, 20, 112, 168, 113, 111, 129, 162, 96, 136, 98, 
                164, 131, 117, 132, 165, 99, 138, 102, 151, 119, 150, 120, 
                152, 103, 154, 121, 153, 122, 155, 104, 157, 123, 156, 124, 
                158, 105, 139, 140, 133, 166, 100, 108, 161, 147, 148, 144, 
                149, 118, 167, 101, 137, 116, 130, 163, 97, 107, 114, 169, 
                115, 110, 135, 127, 170, 128, 143, 142, 146, 145, 95, 106, 
                125, 159, 126, 160, 109, 134, 141, 59, 10, 9, 8, 7, 6, 5, 4, 
                3, 2}]}}}], {{{}, {}, {
              Hue[0.67, 0.6, 0.6], 
              RGBColor[0.49, 0, 0], 
              Line[CompressedData["
1:
AAAAAAAAAACRCkRo
               "]]}, {
              Hue[0.9060679774997897, 0.6, 0.6], 
              RGBColor[0.6, 0.73, 0.36], 
              Line[CompressedData["
1:

               "]]}, {
              Hue[0.1421359549995791, 0.6, 0.6], 
              RGBColor[0.25, 0.43, 0.82], 
              Line[CompressedData["
1:
               "]]}, {
              Hue[0.37820393249936934`, 0.6, 0.6], 
              RGBColor[0.48, 0.11, 0.56], 
              Line[CompressedData["
1:
               "]]}}}, 
           Text["A", {0.2, 0.2}], 
           Text["B", {0.2, 1}], 
          ...
          AspectRatio -> 1, 
           ...
           PlotRange -> {{0, 8}, {0, 8.5}}, PlotRangeClipping -> True, 
           PlotRangePadding -> {
             Scaled[0.02], 
             Scaled[0.02]}}], 
        Attributes[PlotRange] = {
         ReadProtected}, $CellContext`objfun = {$CellContext`t/8 + 
          2 $CellContext`x, $CellContext`t/6 + $CellContext`x/
           2, $CellContext`t/4 - $CellContext`x/
          4, $CellContext`t/2 - (3 $CellContext`x)/2, $CellContext`t - 
          3 $CellContext`x, 
          0.1 $CellContext`t + $CellContext`x, $CellContext`t/
          5, $CellContext`t/4 - $CellContext`x/2, $CellContext`t - 
          2 $CellContext`x, 7 - $CellContext`t/2}, $CellContext`y[
          Pattern[$CellContext`t, 
           Blank[]]] = 
        7 - $CellContext`t/
         2, $CellContext`standardobjfun = {(-16) $CellContext`x + 
          8 $CellContext`y, (-3) $CellContext`x + 
          6 $CellContext`y, $CellContext`x + 4 $CellContext`y, 
          3 $CellContext`x + 2 $CellContext`y, 
          3 $CellContext`x + $CellContext`y, 10 - 10 $CellContext`x, 
          5 $CellContext`y, 2 $CellContext`x + 4 $CellContext`y, 
          2 $CellContext`x + $CellContext`y, 14 - 2 $CellContext`y}}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`feasibleregion = RegionPlot[
            
            And[$CellContext`x + 2 $CellContext`y <= 6, 
             2 $CellContext`x + $CellContext`y <= 
             8, $CellContext`y - $CellContext`x <= 1, $CellContext`y <= 
             2], {$CellContext`x, 0, 8}, {$CellContext`y, 0, 8.5}, Frame -> 
            False]; Null, $CellContext`region = 
          Plot[{3 - $CellContext`x/2, 8 - 2 $CellContext`x, 
             1 + $CellContext`x, 2}, {$CellContext`x, 0, 8}, 
            PlotRange -> {0, 8.5}, PlotStyle -> {
              RGBColor[0.49, 0, 0], 
              RGBColor[0.6, 0.73, 0.36], 
              RGBColor[0.25, 0.43, 0.82], 
              RGBColor[0.48, 0.11, 0.56]}]; 
         Null, $CellContext`labeledregion = 
          Show[$CellContext`feasibleregion, $CellContext`region, 
            Graphics[
             Text["A", {0.2, 0.2}]], 
            Graphics[
             Text["B", {0.2, 1}]], 
            ...
            Graphics[
             Text["F", {4.2, 0.1}]]]; 
         Null, $CellContext`objfun = {$CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = (1/8) $CellContext`t + 
             2 $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = (1/6) $CellContext`t + (1/
               2) $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = (1/4) $CellContext`t - (1/
              4) $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = (1/2) $CellContext`t - (3/
              2) $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = $CellContext`t - 3 $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = 0.1 $CellContext`t + $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = (1/5) $CellContext`t, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = (1/4) $CellContext`t - (1/
              2) $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = $CellContext`t - 2 $CellContext`x, $CellContext`y[
              Pattern[$CellContext`t, 
               Blank[]]] = 7 - $CellContext`t/2}; 
         Null, $CellContext`standardobjfun = {(-16) $CellContext`x + 
            8 $CellContext`y, (-3) $CellContext`x + 
            6 $CellContext`y, $CellContext`x + 4 $CellContext`y, 
            3 $CellContext`x + 2 $CellContext`y, 
            3 $CellContext`x + $CellContext`y, (-10) $CellContext`x + 10, 
            5 $CellContext`y, 2 $CellContext`x + 4 $CellContext`y, 
            2 $CellContext`x + $CellContext`y, 14 - 2 $CellContext`y}; 
...
Cell["\<\
This Demonstration illustrates the graphical solution to several linear \
programming problems, all of which have the same set of constraints; you can \
vary the objective function. When two corner points are optimal, so are all \
the points on the line segment connecting them. The region shaded in blue is \
the feasible region and the colored lines correspond to the constraints. The \
black line represents the chosen objective function set to the slider value.  \
\>", "ManipulateCaption",
 CellID->93247937],
...
Cell[TextData[{
 "In this Demonstration, it is not possible to choose an objective function \
that makes ",
 Cell[BoxData[
  FormBox[
   StyleBox["A",
    FontSlant->"Plain"], TraditionalForm]], "InlineMath"],
 " optimal because such an objective function would either involve a \
minimization problem or a maximization problem with negative coefficients for \
",
 Cell[BoxData[
 ...
 ". Such problems would require different values for the right hand side and \
so do not fit well with the slider. You cannot make ",
 Cell[BoxData[
  FormBox[
   StyleBox["A",
    FontSlant->"Plain"], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   StyleBox["B",
    FontSlant->"Plain"], TraditionalForm]], "InlineMath"],
 " optimal because such an objective function would be a vertical line."
}], "DetailNotes",
 CellID->179054719],
...
Cell[TextData[{
 ButtonBox["Simplex Algorithm",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/SimplexMethod.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
GraphicalLinearProgrammingForTwoVariables&version=0012"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
GraphicalLinearProgrammingForTwoVariables/\
GraphicalLinearProgrammingForTwoVariables-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Graphical Linear Programming for Two Variables",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
GraphicalLinearProgrammingForTwoVariables/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
GraphicalLinearProgrammingForTwoVariables/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Olivia M. Carducci",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Olivia+M.+\
Carducci"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Olivia+M.+Carducci"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[53259, 943, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[53520, 952, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[63875, 1213, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 90573, 1782},
 {"Copyright", 90768, 1787}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35011, 592, 17719, 339, 70, "Output",
 CellID->122063440],
Cell[52733, 933, 523, 8, 70, "ManipulateCaption",
 CellID->93247937],
Cell[53259, 943, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[53520, 952, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[55448, 998, 33, 0, 70, "DetailsSection"],
Cell[55484, 1000, 961, 28, 70, "DetailNotes",
 CellID->179054719],
Cell[56448, 1030, 44, 0, 70, "RelatedLinksSection"],
Cell[56495, 1032, 575, 20, 70, "RelatedLinks",
 CellID->198776949],
Cell[57073, 1054, 570, 20, 70, "RelatedLinks",
 CellID->292394190],
Cell[57646, 1076, 4866, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[62515, 1169, 45, 0, 70, "CitationSection"],
Cell[62563, 1171, 932, 27, 70, "Citations"],
Cell[63498, 1200, 374, 11, 70, "Author"],
Cell[63875, 1213, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature ZTarj9FHHR9PlwANKocicw@R *)
