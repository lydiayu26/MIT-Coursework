...
Price1 = [26.00, 29.00, 30.50, 27.50, 29.00, 27.50, 27.50, 29.00, 35.00, 35.00,
...
Price4 = [23.40, 26.10, 27.45, 24.75, 26.10, 24.75, 24.75, 26.10, 31.50, 31.50, 
...
Price8 = [22.10, 24.65, 25.93, 23.38, 24.65, 23.38, 23.38, 24.65, 29.75, 29.75, 
...
Price16 = [20.80, 23.20, 24.40, 22.00, 23.20, 22.00, 22.00, 23.20, 28.00, 28.00, 
...
TotalInDemand = zeros(Int64, 50)
for t = 1:50
    TotalInDemand[t] += Demand1[t]
    TotalInDemand[t:min(t+3,50)] .+= Demand4[t]
    TotalInDemand[t:min(t+7,50)] .+= Demand8[t]
    TotalInDemand[t:min(t+15,50)] .+= Demand16[t]    
end
for t = 2:4
    TotalInDemand[1:t-1] .+= OldReturn4[t]
end
for t = 2:8
    TotalInDemand[1:t-1] .+= OldReturn8[t]
end
for t = 2:16
    TotalInDemand[1:t-1] .+= OldReturn16[t]
end
